...
export const ModalAP: React.FC<ModalProps> = ({ isOpen, onClose, onSucces }) => {
...
const handleChange = (
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiCall("insert_paciente", {
        nombreP: formData.nombre || "",
        apellidoP: formData.apellido || "",
        idSexo: parseInt(formData.sexo) || '0',
        idTipoDoc: parseInt(formData.tipoDocumento) || '0',
        ...
        >
          ...
          >
            <div className="relative bg-gradient-to-r from-teal-400 to-blue-500 p-6">
              <h2 className="text-2xl font-bold text-white mb-2">Agregar Paciente</h2>
